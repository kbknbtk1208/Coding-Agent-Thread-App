...
import { AgentChoiceSelect } from './agent-choice-select';
...
import { getCodexReasoningOptions } from './use-codex-model-selection';
...
export function AgentReviewNewRunPanel({
  ...
  const codexReasoningOptions = getCodexReasoningOptions(
    review.codexModelState.models,
    review.codexModelState.selectedModel,
  );
  ...
  return (
    <div className="flex flex-col gap-3 px-4 py-3">
      ...
      <div className="flex items-center gap-2">
        <AgentChoiceSelect
          value={review.selectedAgent}
          onChange={review.setSelectedAgent}
